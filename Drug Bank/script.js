...
function displayDrugInfo(drugInfo) {
    ...
    if (drugInfo) {
        drugInfoSection.innerHTML = `
            <h2 style="font-size: 40px;font-weight: bolder;">${drugInfo.name}</h2>
            <br>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Description:</strong> ${drugInfo.description}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Indications:</strong> ${drugInfo.indications}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Side Effects:</strong> ${drugInfo.sideEffects}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Dosage:</strong> ${drugInfo.dosage}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Indications:</strong> ${drugInfo.indications}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Warnings:</strong> ${drugInfo.warnings}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">atcCodes:</strong> ${drugInfo.atcCodes}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">products:</strong> ${drugInfo.products}</p>
            <p style="font-size: 20px;"><strong style="font-size: 25px;font-weight: bolder;">Smiles:</strong> ${drugInfo.smiles}</p>
        `;
    } else {
...
function speakDrugInfo(drugInfo) {
    if (drugInfo) {
        // Concatenate drug information for speech synthesis
        const speechText = `
            ${drugInfo.name}.
